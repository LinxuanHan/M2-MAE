...
class LITS_preprocess:
    ...
    def process(self, ct_path, seg_path, classes=None):
        ...
        # print("downsample shape:",ct_array.shape, seg_array.shape)
    ...
    def write_name_list(self, name_list, file_name):
        ...
        for name in name_list:
            ...
            # seg_path = os.path.join(self.fixed_path, 'label', name[:-7]+"_seg"+name[-7:])
            seg_path = os.path.join(self.fixed_path, 'label', name)
            f.write(ct_path + ' ' + seg_path + "\n")
        f.close()

if __name__ == '__main__':
    raw_dataset_path = r'E:\3DUNet-BraTS2023_ET\data'
    fixed_dataset_path = r'E:\3DUNet-BraTS2023_ET\data'
